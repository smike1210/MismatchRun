...
public class iapManager : MonoBehaviour, IStoreListener
{
    ...
    public static string PRODUCT_NO_ADS = "ad_free";
    ...
    // Apple curren tly requires explicit purchase restoration for IAP, conditionally displaying a password prompt.
